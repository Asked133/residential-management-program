export const environment = {
  ...
  services: {
    default: (import.meta as any).env?.['NG_APP_API_URL'] || 'https://residential-management-program-1.onrender.com',
    usuarios: (import.meta as any).env?.['NG_APP_USUARIOS_API_URL'] || 'https://usuarios-api-n1qi.onrender.com',
    viviendas: (import.meta as any).env?.['NG_APP_VIVIENDAS_API_URL'] || 'https://residential-management-program-1.onrender.com',
    condominios: (import.meta as any).env?.['NG_APP_CONDOMINIOS_API_URL'] || 'https://residential-management-program-1.onrender.com'
  },

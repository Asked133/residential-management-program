    ...
    <div class="min-h-screen bg-[#F7F7F7] text-[#0f172a] font-sans antialiased">
      ...
      <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <a routerLink="/dashboard/admin/residentes" class="bg-white p-6 rounded-xl border border-slate-200 shadow-xs flex items-center gap-4 hover:border-slate-300 transition-all cursor-pointer">
          ...
          <a routerLink="/dashboard/admin/viviendas" class="bg-white p-6 rounded-xl border border-slate-200 shadow-xs flex items-center gap-4 hover:border-slate-300 transition-all cursor-pointer">
